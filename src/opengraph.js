export default function(data) {
    ...
    return [
        ...
        {itemprop: 'image', content: data.image ? data.image : 'https://open.uappexplorer.com/assets/logo.png'},
        ...
        {name: 'twitter:image:src', content: data.image ? data.image : 'https://open.uappexplorer.com/assets/logo.png'},

        // Open Graph data
        {property: 'og:title', content: data.title ? data.title : 'OpenStore'},
        {property: 'og:type', content: 'website'},
        {property: 'og:url', content: window.location.href},
        {property: 'og:image', content: data.image ? data.image : 'https://open.uappexplorer.com/assets/logo.png'},
