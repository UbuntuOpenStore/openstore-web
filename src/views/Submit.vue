      ...
      <div class="row">
        ...
        <ul class="p-list">
          <li
            ...
            v-translate
          >Apps not requiring manual review can be submitted by logging in with the "Log In" link above.</li>
          <li
            class="p-list__item is-ticked"
            v-translate
          ...
          <li class="p-list__item is-ticked">
            <a
              href="/telegram"
              v-translate
            >Apps requiring manual review must be submitted by contacting an admin in our telegram group.</a>
          </li>
          <li
            class="p-list__item is-ticked"
            v-translate
          >You must read over the content policy detailed below.</li>
        </ul>
      </div>
    </div>
        ...
        <ul class="p-list">
          <li class="p-list__item is-ticked">
            <a
              href="/telegram"
              v-translate
            >Send us a link to a repository for your app to our telegram group along with some instructions on how to build it.</a>
          </li>
          <li class="p-list__item is-ticked" v-translate>
      ...
      <div class="row">
        ...
        <ul class="p-list">
          ...
          <li class="p-list__item is-ticked">
            ...
            <span
              v-translate
            >Apps containing or promoting child abuse or child sexual abuse are strictly prohibited.</span>
          </li>
          <li class="p-list__item is-ticked">
          ...
          <li class="p-list__item is-ticked">
            ...
            <span v-translate>App containing or promoting any of the above are strictly prohibited.</span>
          </li>
          <li class="p-list__item is-ticked">
          ...
          <li class="p-list__item is-ticked">
            ...
            <span v-translate>Apps promoting illegal activities (based on USA law) are not allowed.</span>
          </li>
          <li class="p-list__item is-ticked">
    ...
    <div class="p-strip">
      <div class="row">
        <router-link
          ...
          v-translate
        >Login to submit your app</router-link>
        <div v-if="user">
          ...
          <form class="p-form p-form--stacked">
            <div class="p-form__group">
              ...
              <input type="text" id="id" class="p-form__control" :disabled="saving" v-model="id" />
  ...
  methods: {
    submit() {
      if (!this.saving) {
        ...
        api.manage
          .create(
            { id: this.id.toLowerCase(), name: this.name },
            this.user.apikey,
          )
          .then((app) => {
            this.saving = false;
